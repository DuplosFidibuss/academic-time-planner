...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\columnwidth]{Linking_2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\columnwidth]{Linking_tasks1}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\columnwidth]{Linking_tasks2}
